class FizzbeeMbt < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/fizzbee-io/fizzbee-mbt/releases/download/v0.0.1/fizzbee-mbt-0.0.1-macos_arm.tar.gz"
      sha256 "c1509e016010daa691593415579b0b3759be1c031a10524681df59602049d732"
    else
      url "https://github.com/fizzbee-io/fizzbee-mbt/releases/download/v0.0.1/fizzbee-mbt-0.0.1-macos_x86.tar.gz"
